...
use App\Entity\User;
use App\Form\Type\ResetPassword\ChangePasswordFormType;
use App\Form\Type\ResetPassword\ResetPasswordRequestFormType;
...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, RouterInterface $router)
    {
    ...
    private function processSendingPasswordResetEmail(string $emailFormData): RedirectResponse
    {
        ...
        $message = (new \Swift_Message('Quiz Class '))
            ->setSubject("Redefinir senha Quiz Class")
            ...
            ->setBody(
                $this->renderView(
                    ...
                    [
                        ...
                        'tokenLifetime' => $resetToken->getExpiresAtIntervalInstance()
                    ]
                ),
                'text/html'
            );
