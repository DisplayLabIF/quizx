...
class ProfessorMyGoogleAuthenticator extends SocialAuthenticator
{
    use TargetPathTrait;
    ...
    public function supports(Request $request)
    {
        ...
        return $request->attributes->get('_route') === 'connect_google_check_professor';
    }
