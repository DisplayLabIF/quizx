...
class AlunoMyFacebookAuthenticator extends SocialAuthenticator
{
    use TargetPathTrait;
    ...
    public function supports(Request $request)
    {
        ...
        return $request->attributes->get('_route') === 'connect_facebook_check_aluno';
    }
